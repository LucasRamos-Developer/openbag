...
import com.openbag.dto.RestaurantOnboardingRequest;
...
public class RestaurantOnboardingService {
    ...
    private Address createAddress(com.openbag.dto.AddressDTO addressDTO, Restaurant restaurant) {
    ...
    private LayoutConfig createLayoutConfig(com.openbag.dto.LayoutConfigDTO layoutConfigDTO, Restaurant restaurant) {
    ...
    private List<OpeningHour> createOpeningHours(List<com.openbag.dto.OpeningHourDTO> openingHourDTOs, Restaurant restaurant) {
        List<OpeningHour> openingHours = new ArrayList<>();

        for (com.openbag.dto.OpeningHourDTO dto : openingHourDTOs) {
